...
(function($) {
    ...
    $(document).scroll(function() {
      ...
      if ($(this).scrollTop() > $('#lead-content>h1').offset().top ) {
        $('header').css("background","linear-gradient(to bottom,rgba(0,0,0,1),rgba(0,0,0,0.8))");
        $('#mobile-menu-open').css("background","linear-gradient(to bottom,rgba(0,0,0,1),rgba(0,0,0,0.8))");
        $('.profile').css("visibility","visible");
        $('#mobile-menu-open>div').css("visibility","visible");
      } 
      else {
        $('header').css("background","transparent");
        $('#mobile-menu-open').css("background","transparent");
        $('.profile').css("visibility","hidden");
        $('#mobile-menu-open>div').css("visibility","hidden");
      }
    })
